package com.zenithsk.calculator2
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initClickListener() {
        ...
        DarkTheme.setOnClickListener { view -> onClick(view)}
        LightTheme.setOnClickListener { view -> onClick(view)}
    }
    ...
    private fun onClick(view : View) {
        ...
        when(view) {
            ...
            //Theme（textview) ? darkmod : lightmod
            DarkTheme -> {
                    //主布局和分割线变黑
                    mainframelayout.setBackgroundColor(Color.parseColor("#090909"))
                    scroll_view.setBackgroundColor(Color.parseColor("#090909"))
                    horizontal_divider_100.setBackgroundColor(Color.parseColor("#090909"))
                    horizontal_divider_44.setBackgroundColor(Color.parseColor("#090909"))
                    horizontal_divider_58.setBackgroundColor(Color.parseColor("#090909"))
                    horizontal_divider_72.setBackgroundColor(Color.parseColor("#090909"))
                    horizontal_divider_86.setBackgroundColor(Color.parseColor("#090909"))
                    vertical_divider_25.setBackgroundColor(Color.parseColor("#090909"))
                    vertical_divider_50.setBackgroundColor(Color.parseColor("#090909"))
                    vertical_divider_75.setBackgroundColor(Color.parseColor("#090909"))
                    history_text.setTextColor(Color.parseColor("#ffff8800"))
                    result_text.setTextColor(Color.parseColor("#ffff8800"))
                    text_0.setTextColor(Color.parseColor("#FFFFEE"))
                    text_1.setTextColor(Color.parseColor("#FFFFEE"))
                    text_2.setTextColor(Color.parseColor("#FFFFEE"))
                    text_3.setTextColor(Color.parseColor("#FFFFEE"))
                    text_4.setTextColor(Color.parseColor("#FFFFEE"))
                    text_5.setTextColor(Color.parseColor("#FFFFEE"))
                    text_6.setTextColor(Color.parseColor("#FFFFEE"))
                    text_7.setTextColor(Color.parseColor("#FFFFEE"))
                    text_8.setTextColor(Color.parseColor("#FFFFEE"))
                    text_9.setTextColor(Color.parseColor("#FFFFEE"))

            }
            LightTheme -> {
                //主布局和分割线还原
                mainframelayout.setBackgroundColor(Color.parseColor("#ffffffff"))
                scroll_view.setBackgroundColor(Color.parseColor("#ffffffff"))
                horizontal_divider_100.setBackgroundColor(Color.parseColor("#dedede"))
                horizontal_divider_44.setBackgroundColor(Color.parseColor("#dedede"))
                horizontal_divider_58.setBackgroundColor(Color.parseColor("#dedede"))
                horizontal_divider_72.setBackgroundColor(Color.parseColor("#dedede"))
                horizontal_divider_86.setBackgroundColor(Color.parseColor("#dedede"))
                vertical_divider_25.setBackgroundColor(Color.parseColor("#dedede"))
                vertical_divider_50.setBackgroundColor(Color.parseColor("#dedede"))
                vertical_divider_75.setBackgroundColor(Color.parseColor("#dedede"))
                history_text.setTextColor(Color.parseColor("#ff000000"))
                result_text.setTextColor(Color.parseColor("#ff000000"))
                text_0.setTextColor(Color.parseColor("#ff000000"))
                text_1.setTextColor(Color.parseColor("#ff000000"))
                text_2.setTextColor(Color.parseColor("#ff000000"))
                text_3.setTextColor(Color.parseColor("#ff000000"))
                text_4.setTextColor(Color.parseColor("#ff000000"))
                text_5.setTextColor(Color.parseColor("#ff000000"))
                text_6.setTextColor(Color.parseColor("#ff000000"))
                text_7.setTextColor(Color.parseColor("#ff000000"))
                text_8.setTextColor(Color.parseColor("#ff000000"))
                text_9.setTextColor(Color.parseColor("#ff000000"))
            }
